...
async function checkWeather(city){
    const api_key = "26652f1066abd60d45e40425f0ec4831";
    ...
    const sunriseTime = new Date(weather_data.sys.sunrise * 1000);
    const sunsetTime = new Date(weather_data.sys.sunset * 1000);
